...
class HomeViewController: BaseViewController {
    private let gomsLabel = UILabel().then {
        $0.setLabel(text: "GOMS", fName: "FProText-SemiBold", size: 22)
    ...
    private let outingLabel = CustomLabel().then {
        ...
        $0.text = "외출금지"
        $0.textColor = .red
        $0.font = UIFont(name: "FProText-Regular", size: 13)
    ...
    private let statusLabel2 = UILabel().then {
        $0.setLabel(text: "48", fName: "FProText-Regular", size: 20)
        $0.textColor = .orangeCustom
    }
    
    private let statusLabel3 = UILabel().then {
        $0.setLabel(text: "명이 외출 중이에요!", fName: "FProText-Regular", size: 20)
    }
    ...
    private let lateLabel = UILabel().then {
        $0.setLabel(text: "지각의 전당", fName: "FProText-SemiBold", size: 28)
        $0.textColor = .gray
    }
    ...
    private let myNameLabel = UILabel().then {
        $0.setLabel(text: "김주은", fName: "FProText-Regular", size: 15)
    }
    
    private let myClassNumLabel = UILabel().then {
        $0.setLabel(text: "2학년 1반 2번", fName: "FProText-Regular", size: 13)
        $0.textColor = .lightGray
    }
